function [out] = readSentinel(file)
%out=[];
meta = xml2struct(file);

out.date = meta.n1_Level_1C_Tile_ID.n1_General_Info.SENSING_TIME.Text(1:10);
out.processing = meta.n1_Level_1C_Tile_ID.n1_General_Info.DATASTRIP_ID.Text;
% for i =1 :13
...
out.SunAngle = str2num(meta.n1_Level_1C_Tile_ID.n1_Geometric_Info.Tile_Angles.Mean_Sun_Angle.ZENITH_ANGLE.Text);
out.AzimuthAngle = str2num(meta.n1_Level_1C_Tile_ID.n1_Geometric_Info.Tile_Angles.Mean_Sun_Angle.AZIMUTH_ANGLE.Text);

for m = 1:size(meta.n1_Level_1C_Tile_ID.n1_Geometric_Info.Tile_Angles.Mean_Viewing_Incidence_Angle_List.Mean_Viewing_Incidence_Angle,2)
    
     out.MeanView(m,:) = str2num(meta.n1_Level_1C_Tile_ID.n1_Geometric_Info.Tile_Angles.Mean_Viewing_Incidence_Angle_List.Mean_Viewing_Incidence_Angle{1,m}.ZENITH_ANGLE.Text);
     out.MeanAzimuth(m,:)= str2num(meta.n1_Level_1C_Tile_ID.n1_Geometric_Info.Tile_Angles.Mean_Viewing_Incidence_Angle_List.Mean_Viewing_Incidence_Angle{1,m}.AZIMUTH_ANGLE.Text);
...
%      out.MeanAzimuth(m,:) = out.ViewAngle{1,m}.AzimuthAngle;
     ...
     out.AzimuthAng = mean(out.MeanAzimuth);
